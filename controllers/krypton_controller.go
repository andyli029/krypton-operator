...
// +kubebuilder:rbac:groups=qingcloud.com.qingcloud.com,resources=kryptons,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=qingcloud.com.qingcloud.com,resources=kryptons/status,verbs=get;update;patch
